...
export default function Search() {
  ...
  return (
    <aside className="flex flex-col w-full border-solid border-2 rounded-full min-w-min px-2 drop-shadow-md bg-white">
      <form
        className="flex flex-row justify-center items-center px-4"
        onSubmit={handleSearch}
      >
        <label className="flex flex-col w-4/12 bg-transparent text-sm py-4 px-5 rounded-full hover:bg-zinc-200 ">
          Destino
          <input
            className="w-full font-thin text-xs hover:bg-zinc-200 focus:outline-none"
            type="destination"

...
//     const [typerent, setTypeRent] = useState(''); // Estado para almacenar el tipo de renta
//     const [location, setLocation] = useState(''); // Estado para almacenar la locación del inmueble
//     const [address, setAddress] = useState({ // Estado para almacenar la dirección del inmueble, con subcampos de puerta, piso y escalera
//         street: '',
//         door: '',
//         floor: '',
//         staircase: '',
...
//     const [basicInfo, setBasicInfo] = useState({ // Estado para almacenar la información básica del espacio
//         guests: 0,
//         bedrooms: 0,
//         beds: 0,
//         bathrooms: 0,
...
//     const [title, setTitle] = useState(''); // Estado para almacenar el título del apartamento
...
//         formData.append('type_rent', typerent);
...
//                         onChange={(e) => setAddress({ ...address, staircase: e.target.value })}
...
//                         onChange={(e) => setBasicInfo({ ...basicInfo, guests: e.target.value })}
//                         required
//                     />
//                 </label>
//                 <label>
...
//                         onChange={(e) => setBasicInfo({ ...basicInfo, beds: e.target.value })}
//                         required
//                     />
//                 </label>
//                 <label>
